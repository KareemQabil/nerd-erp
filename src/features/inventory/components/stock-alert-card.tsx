...
import { StockAlert } from '../types/inventory.types';
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm font-['Almarai'] mb-2 text-right">{getAlertTitle()}</p>
          <div className="flex items-center gap-4 text-xs font-['Almarai'] text-[#c2c7ce]">
            <span>
              الحالي: <span className="font-['Arial'] font-bold">{alert.currentStock}</span>
            </span>
            <span>
              الحد: <span className="font-['Arial'] font-bold">{alert.threshold}</span>
            </span>
            <span>
