...
const generateMockCategories = (): Category[] => [
  { id: 'cat-1', name: 'المشروبات الساخنة', nameEn: 'Hot Drinks', icon: '☕', color: '#ef4444', productCount: 24 },
  { id: 'cat-2', name: 'المشروبات الباردة', nameEn: 'Cold Drinks', icon: '🥤', color: '#3b82f6', productCount: 18 },
  { id: 'cat-3', name: 'المخبوزات', nameEn: 'Bakery', icon: '🥐', color: '#f59e0b', productCount: 32 },
  { id: 'cat-4', name: 'الحلويات', nameEn: 'Desserts', icon: '🍰', color: '#ec4899', productCount: 28 },
  { id: 'cat-5', name: 'السلطات', nameEn: 'Salads', icon: '🥗', color: '#10b981', productCount: 15 },
  { id: 'cat-6', name: 'الوجبات الرئيسية', nameEn: 'Main Dishes', icon: '🍽️', color: '#8b5cf6', productCount: 42 },
];
...
const generateMockProducts = (): Product[] => {
  ...
  const products: Product[] = [
    // Hot Drinks
    {
      ...
      reorderPoint: 100,
      warehouses: [
        { warehouseId: 'wh-1', warehouseName: 'المستودع الرئيسي', quantity: 250, reserved: 20, available: 230 },
        { warehouseId: 'wh-2', warehouseName: 'مستودع الفرع الثاني', quantity: 150, reserved: 10, available: 140 },
      ],
    ...
    },
    {
      ...
      reorderPoint: 80,
      warehouses: [
        { warehouseId: 'wh-1', warehouseName: 'المستودع الرئيسي', quantity: 180, reserved: 15, available: 165 },
      ],
    ...
    },
    {
      ...
      reorderPoint: 100,
      warehouses: [
        { warehouseId: 'wh-1', warehouseName: 'المستودع الرئيسي', quantity: 75, reserved: 5, available: 70 },
        { warehouseId: 'wh-2', warehouseName: 'مستودع الفرع الثاني', quantity: 30, reserved: 0, available: 30 },
      ],
    ...
    // Cold Drinks
    {
      ...
      reorderPoint: 80,
      warehouses: [
        { warehouseId: 'wh-1', warehouseName: 'المستودع الرئيسي', quantity: 200, reserved: 25, available: 175 },
      ],
    ...
    },
    {
      ...
      reorderPoint: 70,
      warehouses: [
        { warehouseId: 'wh-1', warehouseName: 'المستودع الرئيسي', quantity: 150, reserved: 10, available: 140 },
        { warehouseId: 'wh-2', warehouseName: 'مستودع الفرع الثاني', quantity: 80, reserved: 5, available: 75 },
      ],
      lastRestocked: new Date('2025-11-09'),
      createdAt: new Date('2025-01-01'),
      updatedAt: new Date('2025-11-10'),
    ...
    // Bakery
    {
      ...
      reorderPoint: 200,
      warehouses: [
        { warehouseId: 'wh-1', warehouseName: 'المستودع الرئيسي', quantity: 450, reserved: 30, available: 420 },
        { warehouseId: 'wh-2', warehouseName: 'مستودع الفرع الثاني', quantity: 200, reserved: 15, available: 185 },
      ],
      lastRestocked: new Date('2025-11-10'),
      createdAt: new Date('2025-01-01'),
      updatedAt: new Date('2025-11-10'),
    },
    {
      ...
      reorderPoint: 150,
      warehouses: [
        { warehouseId: 'wh-1', warehouseName: 'المستودع الرئيسي', quantity: 0, reserved: 0, available: 0 },
        { warehouseId: 'wh-2', warehouseName: 'مستودع الفرع الثاني', quantity: 0, reserved: 0, available: 0 },
      ],
    ...
    },
    {
      ...
      reorderPoint: 120,
      warehouses: [
        { warehouseId: 'wh-1', warehouseName: 'المستودع الرئيسي', quantity: 85, reserved: 10, available: 75 },
      ],
      lastRestocked: new Date('2025-11-08'),
      createdAt: new Date('2025-01-01'),
      updatedAt: new Date('2025-11-10'),
    ...
    // Desserts
    {
      ...
      reorderPoint: 80,
      warehouses: [
        { warehouseId: 'wh-1', warehouseName: 'المستودع الرئيسي', quantity: 120, reserved: 8, available: 112 },
        { warehouseId: 'wh-2', warehouseName: 'مستودع الفرع الثاني', quantity: 60, reserved: 4, available: 56 },
      ],
      lastRestocked: new Date('2025-11-09'),
      createdAt: new Date('2025-01-01'),
      updatedAt: new Date('2025-11-10'),
    },
    {
      ...
      reorderPoint: 70,
      warehouses: [
        { warehouseId: 'wh-1', warehouseName: 'المستودع الرئيسي', quantity: 55, reserved: 5, available: 50 },
      ],
      lastRestocked: new Date('2025-11-07'),
      createdAt: new Date('2025-01-01'),
      updatedAt: new Date('2025-11-10'),
...
export class InventoryService {
  ...
  static async getInventoryStats(): Promise<InventoryStats> {
    ...
    return {
      ...
      totalValue: products.reduce((sum, p) => sum + p.price * this.getTotalStock(p), 0),
      totalCost: products.reduce((sum, p) => sum + p.cost * this.getTotalStock(p), 0),
  ...
  static async adjustStock(
    ...
    console.log('Stock adjusted:', { productId, warehouseId, quantity, reason });
  }
  ...
  static async transferStock(
    ...
    console.log('Stock transferred:', { productId, fromWarehouse, toWarehouse, quantity });
  }
  ...
  static async updateWarehouse(warehouse: Partial<Warehouse>): Promise<Warehouse> {
    await new Promise((resolve) => setTimeout(resolve, 500));
