...
export function DrawerClosingModal({
  ...
  const handleDenominationChange = (
    denomination: keyof typeof denominations,
    value: string
  ) => {
  ...
  const denominationFields = [
    {
      key: "bills_500" as const,
      value: 500,
      label: isRTL ? "500 ريال" : "500 SAR",
    },
    {
      key: "bills_200" as const,
      value: 200,
      label: isRTL ? "200 ريال" : "200 SAR",
    },
    {
      key: "bills_100" as const,
      value: 100,
      label: isRTL ? "100 ريال" : "100 SAR",
    },
    {
      key: "bills_50" as const,
      value: 50,
      label: isRTL ? "50 ريال" : "50 SAR",
    },
    {
      key: "bills_10" as const,
      value: 10,
      label: isRTL ? "10 ريال" : "10 SAR",
    },
    ...
    { key: "bills_1" as const, value: 1, label: isRTL ? "1 ريال" : "1 SAR" },
    {
      key: "coins" as const,
      value: 0,
      label: isRTL ? "عملات معدنية" : "Coins",
    },
  ];
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-4">
                ...
                {/* Total Sales */}
                <div className="bg-linear-to-br from-cyan-500 to-blue-600 rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <TrendingUp className="w-5 h-5 text-white" />
                    <span
                      className="text-sm font-['Almarai'] text-white/80"
                      dir="auto"
                    >
                ...
                <div className="bg-[rgba(251,191,36,0.1)] border border-[rgba(251,191,36,0.2)] rounded-xl p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span
                      className="text-sm font-['Almarai'] text-amber-400"
                      dir="auto"
                    >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  {denominationFields.map((field) => (
                    <div
                      key={field.key}
                      className="bg-[rgba(255,255,255,0.05)] border border-[rgba(255,255,255,0.1)] rounded-xl p-3"
                    >
                      <div className="flex items-center gap-3">
                        <div className="flex-1">
                          <div
                            className="text-sm font-['Almarai'] text-[#e2e2e6] mb-1"
                            dir="auto"
                          >
                            {field.label}
                          </div>
                          {field.value > 0 && (
                            <div className="text-xs text-[#c2c7ce] font-['Inter']">
                              {denominations[field.key]} × {field.value} ={" "}
                              {(denominations[field.key] * field.value).toFixed(
                                2
                              )}{" "}
                              ر.س
                            </div>
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleDenominationChange(field.key, e.target.value)
                          }
                          disabled={isProcessing}
                          placeholder="0"
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label
                    className="block text-sm font-['Almarai'] font-bold text-[#e2e2e6] mb-2"
                    dir="auto"
                  >
                    {isRTL ? "ملاحظات" : "Notes"}
                  </label>
                ...
                {!isBalanced && actualCash > 0 && (
                  <div className="bg-[rgba(239,68,68,0.1)] border border-[rgba(239,68,68,0.2)] rounded-xl p-4 flex gap-3">
                    ...
                    <p
                      className="text-xs text-red-400 font-['Almarai'] leading-relaxed"
                      dir="auto"
                    >
                      {isRTL
            ...
            >
              {showSummary ? (
                <>
                  ...
                  <span dir="auto">
                    {isRTL ? "تمت التقفيلة بنجاح" : "Closing Complete"}
                  </span>
                </>
              ) : isProcessing ? (
                <>
                ...
                <>
                  <Check className="w-6 h-6" />
                  <span dir="auto">
                    {isRTL ? "إتمام التقفيلة" : "Complete Closing"}
                  </span>
                </>
              )}
            </button>
