      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-3xl max-h-[80vh] bg-[var(--surface)] rounded-2xl shadow-2xl z-100 overflow-hidden"
          >
            {/* Header */}
            <div className="flex items-center justify-between px-6 py-4 bg-[var(--surface-variant)] border-b border-[var(--outline-variant)]">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-[var(--primary)] flex items-center justify-center">
                  <Clock className="w-5 h-5 text-[var(--on-primary)]" />
                </div>
                <div>
                  ...
                  <AnimatePresence mode="popLayout">
                    {heldOrders.map((order, index) => (
                      <motion.div
                        ...
                        className="group bg-[var(--surface-variant)] border border-[var(--outline-variant)] rounded-xl p-4 hover:border-[var(--primary)] transition-all cursor-pointer"
                      ...
                      >
                        ...
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <button
                            ...
                            className="opacity-0 group-hover:opacity-100 w-8 h-8 rounded-lg hover:bg-[var(--error-container)] hover:text-[var(--error)] text-[var(--on-surface-variant)] transition-all flex items-center justify-center"
                          >
                        ...
                        <motion.button
                          ...
                          whileTap={{ scale: 0.98 }}
                          onClick={() => onRetrieve(order.id)}
                          className="w-full py-2.5 rounded-lg bg-[var(--primary)] text-[var(--on-primary)] font-['Almarai'] font-bold text-sm flex items-center justify-center gap-2 hover:opacity-90 transition-opacity"
                        >
