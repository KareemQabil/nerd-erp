        ...
        <>
          ...
          >
            ...
            <motion.div
              ...
              className="bg-linear-to-b from-[#1a1c1e] via-[#1d2222] to-[#2a2f35] rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden"
            >
              {/* Header */}
                ...
                {loading ? (
                  ...
                  Object.entries(groupedTables).map(([zone, zoneTables]) => (
                    <div key={zone}>
                      {/* Zone Header */}
                      <h3
                        className="text-lg font-['Almarai'] font-bold text-[#e2e2e6] mb-3 capitalize"
                        dir="auto"
                      >
                        {zone === "indoor"
                          ? "داخلي"
                      ...
                      <div className="grid grid-cols-4 gap-3">
                        {zoneTables.map((table) => (
                          <motion.button
                            ...
                            whileTap={{
                              scale: table.status === "available" ? 0.95 : 1,
                            }}
                            onClick={() => {
                            ...
                            className={`relative p-4 rounded-2xl transition-all ${
                              ...
                              table.status === "available"
                                ? "bg-linear-to-b from-[rgba(16,185,129,0.2)] to-[rgba(5,150,105,0.2)] border border-[#10b981] hover:border-[#22d3ee] cursor-pointer"
                                : table.status === "occupied"
                                ? "bg-linear-to-b from-[rgba(239,68,68,0.2)] to-[rgba(220,38,38,0.2)] border border-[#ef4444] cursor-not-allowed opacity-70"
                                : table.status === "reserved"
                                ? "bg-linear-to-b from-[rgba(245,158,11,0.2)] to-[rgba(217,119,6,0.2)] border border-[#f59e0b] cursor-not-allowed opacity-70"
                                : "bg-linear-to-b from-[rgba(107,114,128,0.2)] to-[rgba(75,85,99,0.2)] border border-[#6b7280] cursor-not-allowed opacity-70"
                            }`}
                          >
                            {/* Status Badge */}
                            <div
                            ...
                            <div className="space-y-1">
                              ...
                              {/* Status Label */}
                              <div
                                className="text-xs font-['Almarai'] text-center mt-1"
                                dir="auto"
                              >
