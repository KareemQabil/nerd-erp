...
import { 
  Keyboard, Mouse, Smartphone, ShoppingCart, Search, 
  Grid, DollarSign, Printer, User, Clock, ArrowRight,
  X, CheckCircle, Info
} from 'lucide-react';
...
export function DemoInstructionsScreen() {
  ...
  const StepItem = ({ number, title, description }: { number: number; title: string; description: string }) => (
    <div className="flex gap-4">
      ...
      <div className="flex-1">
        <h4 className="text-sm font-['Almarai'] font-bold text-[var(--on-surface)] mb-1" dir="auto">
          {title}
        </h4>
        <p className="text-xs font-['Almarai'] text-[var(--on-surface-variant)]" dir="auto">
          {description}
        </p>
      </div>
    </div>
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] pb-20">
      {/* Header */}
      <div className="bg-gradient-to-b from-[var(--surface)] to-[var(--surface-variant)] border-b border-[var(--outline-variant)] sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-['Almarai'] font-bold text-[var(--on-surface)]" dir="auto">
                  دليل الاستخدام التجريبي
                </h1>
                <p className="text-sm text-[var(--on-surface-variant)]" dir="auto">
      ...
      <div className="container mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Keyboard Shortcuts */}
          <Section title="اختصارات لوحة المفاتيح" icon={<Keyboard className="w-5 h-5 text-[var(--on-primary)]" />}>
          ...
          {/* Mouse Actions */}
          <Section title="إجراءات الماوس" icon={<Mouse className="w-5 h-5 text-[var(--on-primary)]" />}>
          ...
          <Section title="الإيماءات اللمسية (الأجهزة اللوحية)" icon={<Smartphone className="w-5 h-5 text-[var(--on-primary)]" />}>
            <div className="space-y-3">
              <StepItem 
                number={1} 
                title="النقر المفرد"
          ...
          {/* Quick Start Guide */}
          <Section title="دليل البدء السريع" icon={<CheckCircle className="w-5 h-5 text-[var(--on-primary)]" />}>
            <div className="space-y-3">
              <StepItem 
                number={1} 
                title="اختر الفئة"
          ...
          {/* Action Bar Guide */}
          <Section title="شريط الإجراءات" icon={<Grid className="w-5 h-5 text-[var(--on-primary)]" />}>
            <div className="space-y-1">
              <div className="flex items-center gap-3 py-2 border-b border-[var(--outline-variant)]">
                ...
                <div className="flex-1">
                  <h4 className="text-sm font-['Almarai'] font-bold text-[var(--on-surface)]" dir="auto">
                    السلة
                  </h4>
          ...
          {/* Tips & Tricks */}
          <Section title="نصائح وحيل" icon={<Info className="w-5 h-5 text-[var(--on-primary)]" />}>
            <div className="space-y-3 bg-[var(--primary-container)] rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm font-['Almarai'] text-[var(--on-primary-container)]" dir="auto">
        ...
        <div className="mt-8 p-6 bg-[var(--surface)] border border-[var(--outline-variant)] rounded-xl">
          <div className="flex items-start gap-4">
            <Info className="w-6 h-6 text-[var(--primary)] flex-shrink-0" />
            <div>
              <h3 className="text-lg font-['Almarai'] font-bold text-[var(--on-surface)] mb-2" dir="auto">
                ملاحظة: هذا عرض تجريبي
              </h3>
              <p className="text-sm font-['Almarai'] text-[var(--on-surface-variant)] leading-relaxed" dir="auto">
                هذا النظام هو نسخة تجريبية لتوضيح الميزات والوظائف. جميع البيانات والمنتجات المعروضة هي بيانات وهمية للتوضيح فقط. 
                في النسخة الكاملة، سيتم ربط النظام بقاعدة بيانات حقيقية وطابعات الإيصالات ونظام الدفع الإلكتروني.
              </p>
            </div>
          </div>
        </div>
