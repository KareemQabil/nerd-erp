...
export default function KitchenDisplayScreen() {
  ...
  const handleStatusUpdate = async (orderId: string, status: KitchenOrderStatus) => {
    try {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <h1 className="font-['Almarai'] text-xl text-[var(--on-surface)]" dir="rtl">
                شاشة المطبخ
              </h1>
            </div>
          </div>
      ...
      <div className="p-6">
        {filteredOrders.length === 0 ? (
          <div className="text-center py-12">
            <p className="text-[var(--on-surface-variant)] font-['Almarai']" dir="rtl">
              لا توجد طلبات
            </p>
          </div>
        ) : (
                ...
                >
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div>
                      ...
                      {order.tableNumber && (
                        <p className="text-sm opacity-70 font-['Almarai']" dir="rtl">
                  ...
                  <div className="space-y-2 mb-4">
                    {order.items.map((item, idx) => (
                      <div key={idx} className="text-sm">
                        ...
                        {item.notes && (
                          <p className="text-xs opacity-70 font-['Almarai'] mt-1" dir="rtl">
                            {item.notes}
                          </p>
                        )}
                      </div>
