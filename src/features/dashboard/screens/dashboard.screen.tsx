...
export default function DashboardScreen() {
  ...
  const recentNotifications = [
    {
      id: 1,
      title: isRTL ? "طلب جديد ORD-0458" : "New order ORD-0458",
    ...
    {
      id: 2,
      title: isRTL ? "تحديث المخزون" : "Stock updated",
      time: isRTL ? "منذ 15 دقيقة" : "15 mins ago",
      icon: Package,
      color: "#22d3ee",
    },
    {
      ...
      time: isRTL ? "منذ 30 دقيقة" : "30 mins ago",
      icon: Users,
      color: "#22d3ee",
    },
  ];
  ...
  const alerts = [
    {
      id: 1,
      message: isRTL ? "15 منتج مخزون منخفض" : "15 products low in stock",
      icon: AlertTriangle,
      color: "#f59e0b",
    },
    {
      id: 2,
      message: isRTL ? "5 طلبات قيد التحضير" : "5 orders in preparation",
      icon: Clock,
      color: "#22d3ee",
    },
    {
      id: 3,
      message: isRTL ? "25 طلب تم تسليمه اليوم" : "25 orders delivered today",
      icon: CheckCircle,
      color: "#10b981",
    },
  ];
  ...
  return (
    <>
      <div className="pt-6 pb-24 px-4" dir={isRTL ? "rtl" : "ltr"}>
        {/* Header */}
        <div className="mb-6">
          <h1
          ...
          <p
            className="text-base text-[#c2c7ce] font-['Almarai'] text-right"
            dir="auto"
          >
            {isRTL
              ? "نظرة عامة على أداء المتجر اليوم"
              : "Overview of store performance today"}
          </p>
        </div>
          ...
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Label */}
                <div
                  className="text-sm font-['Almarai'] text-[#c2c7ce] mb-2 text-right"
                  dir="auto"
                >
                  {stat.label}
                </div>
                ...
                return (
                  ...
                  >
                    <div className="flex-1">
                      <p
                        className="text-sm font-['Almarai'] text-[#e2e2e6] mb-1 text-right"
                        dir="auto"
                      >
                        {notification.title}
                      </p>
                      <p
                        className="text-xs font-['Almarai'] text-[#c2c7ce] text-right"
                        dir="auto"
                      >
                        {notification.time}
                      </p>
              ...
              {alerts.map((alert, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p
                      className="text-sm font-['Almarai'] flex-1"
                      style={{ color: "#e2e2e6" }}
                      dir="auto"
                    >
                      {alert.message}
        ...
        <div className="bg-[#2a2d32] border border-[rgba(255,255,255,0.1)] rounded-xl p-12 text-center">
          ...
          <h2
            className="text-xl font-['Almarai'] font-bold text-[#e2e2e6] mb-2"
            dir="auto"
          >
          ...
          <p className="text-sm text-[#c2c7ce] font-['Almarai']" dir="auto">
            {isRTL
              ? "جاري العمل على إضافة المزيد من التقارير والتحليلات المرئية"
              : "Working on adding more visual reports and analytics"}
          </p>
        </div>
      </div>
    </>
