...
import { 
  ...
  Truck, ChefHat, BarChart3, Building2, LogOut, Armchair
} from 'lucide-react';
...
export function MainNavigation() {
  ...
  return (
    <div className="fixed right-0 top-0 bottom-0 w-20 bg-gradient-to-b from-[#023047] to-[#001219] border-l border-[rgba(255,255,255,0.1)] shadow-2xl z-50 flex flex-col">
      {/* Logo */}
